...
//! GigE Vision transport support.

/// GigE control channel handle implementation.
pub mod control_handle;
/// GigE bootstrap and stream register map wrappers.
pub mod register_map;
/// GigE stream channel handle implementation.
...
/// Enumerates cameras discoverable from the given local IPv4 interface.
