...
//! #### Platform notes
//! ##### Linux/macOS
//! On Linux you may need to adjust device permissions so that your user can access USB cameras. You can add rules with `udev`; a configuration example is found [here](https://github.com/cameleon-rs/cameleon/blob/main/misc/u3v.rules).
//!
//! ##### Windows
