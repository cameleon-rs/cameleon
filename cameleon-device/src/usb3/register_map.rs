/// (Address, Length) of all entries in Technology Agnostic Boot Register Map (ABRM).
pub mod abrm {
...
/// (Offset, Length) of entries in Technology Specific Boot Register Map (SBRM).
...
/// (Offset, Length) of all entries in Event Interface Register Map (EIRM).
